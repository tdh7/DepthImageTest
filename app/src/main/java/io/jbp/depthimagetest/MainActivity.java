...
public class MainActivity extends Activity implements SensorEventListener
{
  ...
  private void showSample() {
    ...
    String imageUri = "/storage/emulated/0/Download/girl.jpg";
    String depthUri = "/storage/emulated/0/Download/girl_depth.jpg";

    Bitmap image = BitmapFactory.decodeFile(imageUri);
    Bitmap depth = BitmapFactory.decodeFile(depthUri);

    renderer = new DepthRenderer(image,depth, getResources());
